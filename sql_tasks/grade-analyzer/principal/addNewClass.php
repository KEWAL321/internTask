...
if($_SERVER["REQUEST_METHOD"] == 'POST' && isset( $_POST['addNewClass'] )) {
    ...
    $stmt->bindValue(":class_name", $_POST["classname"]);
    $stmt->bindValue(":teacher_id", !empty($_POST["class_teacherId"])? $_POST['class_teacherId']: NULL);
    $stmt->execute();
        ...
        <div
            ...
            <form class=" p-8 rounded-lg shadow-lg w-full max-w-md"
                ...
                <div class="mb-4">
                    ...
                    <select name='class_teacherId' class='block text-gray-600 w-full'>
