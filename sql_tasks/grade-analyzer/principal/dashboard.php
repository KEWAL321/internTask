<?php require_once "../connection.php" ;
    ...
    $stmt = $conn->prepare("SELECT COUNT(id) FROM subjects ");
    $stmt->execute();
    $subjectCount = $stmt->fetch(PDO::FETCH_ASSOC);
...
<body>
    ...
    <div class='flex flex-row rounded-[20px] h-[100%] w-[100%] justify-center items-center'>
        ...
        <div
            class='h-[90%] w-[50%] py-10 pl-10 rounded-r-[16px] bg-gray-400/50 grid grid-flow-col grid-rows-2 text-center'>

            <div class='w-[260px] h-[200px]' style="border:1px solid rgb(70,176,255)">
                <p style="border:1px solid rgb(70,176,255)">Teachers</p><br>
                <p><?php echo $teacherCount['COUNT(id)'];    ?></p>
            </div>
            <div class='w-[260px] h-[200px]' style="border:1px solid rgb(70,176,255)">
                <p style="border:1px solid rgb(70,176,255)">Students</p><br>
                <p><?php echo $studentCount["COUNT(id)"]; ?></p>
            </div>
            <div class='w-[260px] h-[200px]' style="border:1px solid rgb(70,176,255)">
                <p style="border:1px solid rgb(70,176,255)">Subject Count</p><br>
                <p><?php echo $subjectCount["COUNT(id)"]; ?></p>
            </div>
            <div class='w-[260px] h-[200px]' style="border:1px solid rgb(70,176,255)">
                <p style="border:1px solid rgb(70,176,255)">Requests</p><br>
                <p> 0</p>
            </div>
